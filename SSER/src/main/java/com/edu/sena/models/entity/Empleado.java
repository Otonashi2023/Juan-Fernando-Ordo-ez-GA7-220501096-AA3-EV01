...
public class Empleado {
	...
	@Column(name = "ape_empl", nullable = false)
	...
	@Column(name = "dir_empl", nullable = false)
	private String direccion;

	@Column(name = "corr_empl", nullable = false)
	...
	public Empleado(int codigo, String nombre, String apellido, long cedula, long telefono, String direccion,
			String correo, long salario, Cargo cargo) {
		super();
		this.codigo = codigo;
		this.nombre = nombre;
		this.apellido = apellido;
